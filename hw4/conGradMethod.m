function [result, num, infNormRes] = conGradMethod(A, b, guess, tolerance)
...
%   solution RESULT, number of iteration NUM,and vector of infinity norm of
%   residuals INFNORMRES.
TOLERANCE = tolerance;
x0 = guess;
tmp = size(A);
n = tmp(1);
